...
public class DenseMatrix implements Serializable {
	...
	public DenseMatrix multTrans() {
		DenseMatrix res = new DenseMatrix(numRows, numRows);
	...
	public DenseMatrix multTrans(double scale) {
		DenseMatrix res = new DenseMatrix(numRows, numRows);
